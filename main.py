...
with seedObject:
    ...
    grads,grads_eval, grads_0, grads_epoch, grads_epoch_0,training_loss_batch, training_loss_epoch, training_acc, test_loss_batch, test_loss_epoch, test_acc, loss_function= train.train(trainloader, model, num_epochs, device, y_train, lr)
